...
export const ModelApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} modelId Model ID.
         * @param {boolean} [xShapediverNoconvert] When set to &#x60;true&#x60;, the config object is returned as stored, without any version conversion applied. [Priority: 1]
         * @param {string} [xShapediverUseconfigversion] When set to &#x60;true&#x60;, the returned config version will be of the same version as when the config object has been created. In case the version number cannot be extracted from the config object, this header is ignored. [Priority: 2]
         * @param {string} [xShapediverBuildversion] When specified, converts the requested config object to the provided target version. Otherwise, the config object is converted into the default version instead. [Priority: 3]
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getModelConfig: async (modelId: string, xShapediverNoconvert?: boolean, xShapediverUseconfigversion?: string, xShapediverBuildversion?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'modelId' is not null or undefined
            ...
            if (xShapediverNoconvert != null) {
                localVarHeaderParameter['x-shapediver-noconvert'] = typeof xShapediverNoconvert === 'string'
                    ? xShapediverNoconvert
                    : JSON.stringify(xShapediverNoconvert, replaceWithSerializableTypeIfNeeded);
            }
            if (xShapediverUseconfigversion != null) {
                localVarHeaderParameter['x-shapediver-useconfigversion'] = String(xShapediverUseconfigversion);
            }
            if (xShapediverBuildversion != null) {
                localVarHeaderParameter['x-shapediver-buildversion'] = String(xShapediverBuildversion);
            }
            setSearchParams(localVarUrlObj, localVarQueryParameter);
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
...
export const ModelApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getModelConfig(modelId: string, xShapediverNoconvert?: boolean, xShapediverUseconfigversion?: string, xShapediverBuildversion?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ResGetModelConfig>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getModelConfig(modelId, xShapediverNoconvert, xShapediverUseconfigversion, xShapediverBuildversion, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const ModelApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getModelConfig(modelId: string, xShapediverNoconvert?: boolean, xShapediverUseconfigversion?: string, xShapediverBuildversion?: string, options?: RawAxiosRequestConfig): AxiosPromise<ResGetModelConfig> {
            return localVarFp.getModelConfig(modelId, xShapediverNoconvert, xShapediverUseconfigversion, xShapediverBuildversion, options).then((request) => request(axios, basePath));
        },
        /**
         * Subject-Restriction: __backend__.
         * @summary List models.
...
export class ModelApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public getModelConfig(modelId: string, xShapediverNoconvert?: boolean, xShapediverUseconfigversion?: string, xShapediverBuildversion?: string, options?: RawAxiosRequestConfig) {
        return ModelApiFp(this.configuration).getModelConfig(modelId, xShapediverNoconvert, xShapediverUseconfigversion, xShapediverBuildversion, options).then((request) => request(this.axios, this.basePath));
    }
