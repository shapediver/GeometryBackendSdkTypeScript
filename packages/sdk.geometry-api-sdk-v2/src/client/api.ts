...
export const SessionApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createSessionByModel: async (modelId: string, modelStateId?: string, ignoreUnknownParams?: boolean, strictValidation?: boolean, reqCustomizationOrExport?: ReqCustomizationOrExport, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'modelId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        createSessionByTicket: async (ticketId: string, modelStateId?: string, ignoreUnknownParams?: boolean, strictValidation?: boolean, reqCustomizationOrExport?: ReqCustomizationOrExport, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const SessionApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createSessionByModel(modelId: string, modelStateId?: string, ignoreUnknownParams?: boolean, strictValidation?: boolean, reqCustomizationOrExport?: ReqCustomizationOrExport, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ResCreateSessionByModel>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createSessionByModel(modelId, modelStateId, ignoreUnknownParams, strictValidation, reqCustomizationOrExport, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async createSessionByTicket(ticketId: string, modelStateId?: string, ignoreUnknownParams?: boolean, strictValidation?: boolean, reqCustomizationOrExport?: ReqCustomizationOrExport, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ResCreateSessionByTicket>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createSessionByTicket(ticketId, modelStateId, ignoreUnknownParams, strictValidation, reqCustomizationOrExport, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const SessionApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createSessionByModel(modelId: string, modelStateId?: string, ignoreUnknownParams?: boolean, strictValidation?: boolean, reqCustomizationOrExport?: ReqCustomizationOrExport, options?: RawAxiosRequestConfig): AxiosPromise<ResCreateSessionByModel> {
            return localVarFp.createSessionByModel(modelId, modelStateId, ignoreUnknownParams, strictValidation, reqCustomizationOrExport, options).then((request) => request(axios, basePath));
        },
        /**
         * Permissions: * `get.parameter.*` - optional: adds _parameters_ to response. * Output:   * If body contains a computation request: `compute.output.*` - __required__.   * If no computation request: `compute.output.*` - optional: adds _output for default     parameter_ to response.   * otherwise tries: `get.output.*` - optional: adds _output definitions_ to response. * Export:   * Body contains an export request: `compute.export.*` - __required__.   * No export request: `get.export.*` - optional: adds _export definitions_ to response.
         * @summary Initialize new session by ticket.
         ...
         * @throws {RequiredError}
         */
        createSessionByTicket(ticketId: string, modelStateId?: string, ignoreUnknownParams?: boolean, strictValidation?: boolean, reqCustomizationOrExport?: ReqCustomizationOrExport, options?: RawAxiosRequestConfig): AxiosPromise<ResCreateSessionByTicket> {
            return localVarFp.createSessionByTicket(ticketId, modelStateId, ignoreUnknownParams, strictValidation, reqCustomizationOrExport, options).then((request) => request(axios, basePath));
        },
        /**
         * Subject-Restriction: __backend__.  Permissions: * `setting.auth.ticket.create.*` - __required__. * `setting.auth.ticket.get.*` - optional: adds _settings.auth.ticket_ to response. * `setting.auth.token.get.*` - optional: adds _settings.auth.token_ to response. * `setting.compute.get.*` - optional: adds _settings.compute_ to response. * `file.upload` - optional: adds _file.upload_ to response. * `file.download` - optional: adds _file.download_ to response. * `get.statistic.*` - optional: adds _statistic_ to response.
         * @summary Create a new ticket that allows to initialize a new session.
...
export class SessionApi extends BaseAPI {
     ...
     * @memberof SessionApi
     */
    public createSessionByModel(modelId: string, modelStateId?: string, ignoreUnknownParams?: boolean, strictValidation?: boolean, reqCustomizationOrExport?: ReqCustomizationOrExport, options?: RawAxiosRequestConfig) {
        return SessionApiFp(this.configuration).createSessionByModel(modelId, modelStateId, ignoreUnknownParams, strictValidation, reqCustomizationOrExport, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof SessionApi
     */
    public createSessionByTicket(ticketId: string, modelStateId?: string, ignoreUnknownParams?: boolean, strictValidation?: boolean, reqCustomizationOrExport?: ReqCustomizationOrExport, options?: RawAxiosRequestConfig) {
        return SessionApiFp(this.configuration).createSessionByTicket(ticketId, modelStateId, ignoreUnknownParams, strictValidation, reqCustomizationOrExport, options).then((request) => request(this.axios, this.basePath));
    }
