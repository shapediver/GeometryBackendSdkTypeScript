...
export function getTestUrl (): string {
    ...
    if (!url) throw new Error("Missing test config value: 'sdUrl'. Set this in 'test.config.js'.")
    return url
}
...
export function getTestOrigin (): string {
    ...
    if (!origin) throw new Error("Missing test config value: 'sdOrigin'. Set this in 'test.config.js'.")
    return origin
}
...
export function getTestTicket (): string {
    ...
    if (!ticket) throw new Error("Missing test config value: 'sdTicket'. Set this in 'test.config.js'.")
    return ticket
}
...
export function getTestJwtBackend (): string {
    ...
    if (!jwt) throw new Error("Missing test config value: 'sdJwtBackend'. Set this in 'test.config.js'.")
    return jwt
}
...
export function getTestJwt1 (): string {
    ...
    if (!jwt) throw new Error("Missing test config value: 'sdJwt1'. Set this in 'test.config.js'.")
    return jwt
}
...
export function getTestJwt2 (): string {
    ...
    if (!jwt) throw new Error("Missing test config value: 'sdJwt2'. Set this in 'test.config.js'.")
    return jwt
}
...
export function getTestModel1 (): string {
    ...
    if (!model) throw new Error("Missing test config value: 'sdModel1'. Set this in 'test.config.js'.")
    return model
}
...
export function getTestModel2 (): string {
    ...
    if (!model) throw new Error("Missing test config value: 'sdModel2'. Set this in 'test.config.js'.")
    return model
}
...
export function getTestSession1 (): string {
    ...
    if (!session) throw new Error("Missing test config value: 'sdSession1'. Set this in 'test.config.js'.")
    return session
}
