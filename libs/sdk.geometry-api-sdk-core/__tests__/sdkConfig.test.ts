...
} from "../src/config/ShapeDiverSdkConfig";
...
describe("setConfigValue", function () {
  ...
  test("request headers - valid", () => {
    config!.setConfigValue(ShapeDiverSdkConfigType.REQUEST_HEADERS, {
      a: "foobar",
    });
...
describe("validateValue", function () {
  test("string - valid", () => {
    SdkConfigInternal.validateValue(
      ShapeDiverSdkConfigType.BASE_URL,
      "foobar",
      "string",
    );
  });
